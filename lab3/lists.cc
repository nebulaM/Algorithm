...
int main() {
  ...
  std::vector<int>* vector1 = to_vector(list1); 
  ...
  std::vector<int>* vector2 = to_vector(list2); 
  ...
  delete_last_element( list1 );
  std::cout << "<E> List 1: ";  // list1 is now empty 
  print( list1 );
  size1 = size(list1); 
  ...
  std::cout << "<F> List 1: ";  // list1 is now empty again  
  print( list1 );
  ...
  std::vector<int>* vector4 = to_vector( list4 ); 
